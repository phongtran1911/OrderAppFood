...
class ListFoodAfternoon extends Component {
    ...
    componentWillReceiveProps(nextProps) {
        const arr = [];
        if (nextProps.mylistFoodAfternoon.type === "SUCCESS_FETCH_DATA_FOODAFTERNOON") {
...
export default connect(mapStateToProps, { fetchData,fetchDataPostOrderOnlyFood })(ListFoodAfternoon);