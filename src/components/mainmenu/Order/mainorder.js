    ...
    render() {
        ...
        return (
            <View style={{flex: 1, backgroundColor: "#FFF"}}>
                ...
                <TouchableOpacity style={styles.wrapper} onPress={() => Actions.push("order", {is_Morning: true})}>
                ...
                <TouchableOpacity style={wrapper}  onPress={() => Actions.push("order", {is_Morning: false})}>
                    <View style={viewImage}>
