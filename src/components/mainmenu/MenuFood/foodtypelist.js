    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          text: 'Xóa',
          onPress: () => {
            this.props.fetchDataDeletePostType(
              this.props.myFoodType.id,
              myFoodID,
            );
          },
        },
      ...
      <View style={{flex: 1}}>
        <View style={styles.container}>
          ...
          <View style={{flexDirection: 'row'}}>
            <TouchableOpacity
              onPress={() =>
                Actions.push('foodtypeedit', {
                  idFoodType: id,
                  Name: Name,
                  is_FoodAdd: is_FoodAdd,
                  idFood: this.props.myFoodID,
                })
              }>
              <Image source={icEdit} style={styles.imageStyle} />
            </TouchableOpacity>
            <TouchableOpacity onPress={this.onDelete.bind(this)}>
              <Image source={icTrash} style={styles.imageStyle} />
            </TouchableOpacity>
          </View>
        </View>
      </View>
