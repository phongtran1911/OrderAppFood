...
class FoodTypeEdit extends Component {
    ...
    onUpdate(){
        ...
        this.props.fetchDataUpdateFoodType(this.state.Name,this.state.is_FoodAdd,idFoodType,idFood);
        alert("Thành công!");
        Actions.pop();
    }
    render() {
        ...
        return (
            <View style={styles.container}>
                ...
                <TouchableOpacity onPress={this.onUpdate.bind(this)} style={styles.buttonAdd}>
                    <Text style={{textAlign:'center', color:'#FFF', fontSize: 16, padding: 5}}>Sửa</Text>
                </TouchableOpacity>
            </View>
        );
    }
...
export default connect(null, { fetchDataUpdateFoodType })(FoodTypeEdit);