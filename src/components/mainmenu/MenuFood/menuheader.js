        ...
        return (
            <View style={styles.header}>
                <TouchableOpacity onPress={() => Actions.pop()}>
                    <Image  style={styles.buttonImage} source={icBack}></Image>
                </TouchableOpacity>
                <Text style={{fontSize: 20, fontWeight: 'bold', color: '#FFF'}}>Món ăn đi kèm</Text>
                <TouchableOpacity onPress={() => this.props.toggleIsAdding()}>                   
                    <Image style={styles.buttonImage} source={this.props.myIsAdding ? icMinus : icPlus}></Image>
                </TouchableOpacity>
            </View>
        );
    }
...
export default connect(mapStateToProps, { toggleIsAdding })(MenuHeader);
